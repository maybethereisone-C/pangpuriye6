...
export function Hero({ data }: { data: SiteData["hero"] }) {
  return (
    ...
    >
      <HeroAnim>
        <div className="mx-auto grid max-w-[var(--grid-max-width)] grid-cols-1 items-center gap-[var(--grid-gutter-mobile)] px-[var(--grid-margin-mobile)] pt-[calc(var(--topbar-h)+1rem)] md:grid-cols-12 md:gap-[var(--grid-gutter-tablet)] md:px-[var(--grid-margin-tablet)] lg:gap-[var(--grid-gutter-desktop)] lg:px-[var(--grid-margin-desktop)] md:pt-[var(--topbar-h)]">
